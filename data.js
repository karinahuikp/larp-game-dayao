...
const TABS = [
  { id: "dossier", icon: "📜", label: "我的卷宗", description: "個人密檔、行動紀錄。" },
  { id: "mission", icon: "🎯", label: "本章任務", description: "推進劇情的必做任務。" },
  { id: "floor", icon: "🏯", label: "聚會現場", description: "與諸人交涉、蒐集線索。" },
];
...
const CHARACTERS = [
  ...
  },
  {
    ...
    missions: { ch1: ["檢驗藥盒", "追查藥材來源", "觀察誰對藥香不適"] },
  ...
  },
  {
    ...
    color: "#9c567e",
    faction: "鳳鳴宮之主，掌諸宮事。",
    scripts: { ch1: "眾人受召前來御花園，今夜你將試探各方心思。" },
    missions: { ch1: ["安排座次", "觀察眾人言行", "記錄誰最不安"] },
    clues: { ch1: ["每個人都欠你一分情面", "有人對座次調整頗有微詞"] },
  },
  {
    id: "gm",
    title: "皇后 / 主持人",
    ...
    missions: { ch1: ["掌握節奏", "保留關鍵訊息到最後", "安排下一章節"] },
...
const CHAPTERS = {
  ch1: {
    title: "御花園茶聚",
    condition: "六角首次登場，確認彼此立場",
    seatTitle: "禁宮入座名錄",
    seatDescription: "皇后召集於御花園，座次即態度，請確認誰已到場。",
  },
